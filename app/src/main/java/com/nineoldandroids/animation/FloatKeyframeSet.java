 ...
 * 
 * <p>
 * This type-specific subclass of KeyframeSet, along with the other type-specific subclass for int, exists to speed up the getValue() method when there is no custom TypeEvaluator set for the animation, so that
 * values can be calculated without autoboxing to the Object equivalents of these primitive types.
 * </p>
 */
